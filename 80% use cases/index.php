...
<body >
  ...
  <div class="w3-bar w3-white w3-wide w3-padding w3-card">
    <a href="#home" class="w3-bar-item w3-button"><b>Emergency Management System</b></a>
    <!-- Float links to the right. Hide them on small screens -->
    <div class="w3-right w3-hide-small">
      <a href="request_equipment.php" class="w3-bar-item w3-button">Add Request for Equipment</a>
